      ...
      <div>
        <div class="flex items-center mb-3">
          <h1 class="mb-3 text-90 font-normal text-2xl">
            <a href="/nova/novashopengine/codeless" class="no-underline text-primary font-bold dim router-link-active"
               data-testid="lens-back">←</a> <span class="px-2 text-70">/</span> Codeless Details
          </h1>
        </div>
        <div class="card mb-6 py-3 px-6">
          ...
          <div class="flex border-b border-40 -mx-6 px-6">
            <div class="w-1/4 py-4">
              <h4 class="font-normal text-80">Start</h4>
            </div>
            <div class="w-3/4 py-4 break-words">
              <div>
          ...
          <div class="flex border-b border-40 -mx-6 px-6">
            <div class="w-1/4 py-4">
              <h4 class="font-normal text-80">End</h4>
            </div>
            <div class="w-3/4 py-4 break-words">
              <div>
