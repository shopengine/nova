  ...
  methods: {
    ...
    async deleteTag(tag) {
      ...
      const {data} = await Nova.request().post(
          `/nova-vendor/novashopengine/shop/marketing-provider/klicktipp/period-tags/${this.tagToDelete}/delete`,
          {}
      );
      if (data.success) {
