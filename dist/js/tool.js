...
/* harmony default export */ __webpack_exports__["a"] = ({
    formatAmount: function formatAmount(amount) {
        ...
        return new Intl.NumberFormat(locale, { style: 'currency', currency: currency }).format(parseInt(amount, 10) / 100);
    },
    formatMoney: function formatMoney(moneyObj) {
        var locale = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'de-DE';

        return new Intl.NumberFormat(locale, { style: 'currency', currency: moneyObj.currency }).format(parseInt(moneyObj.amount, 10) / 100);
    }
});
...
Nova.booting(function (Vue, router, store) {
    ...
    // custom fields
    Vue.component('detail-shippingcostoptions', __webpack_require__(10));
    Vue.component('detail-shippingcostvalidations', __webpack_require__(19));

    Vue.component('detail-purchase-address', __webpack_require__(25));
    Vue.component('detail-purchase-articles', __webpack_require__(28));
    Vue.component('detail-purchase-origin-status', __webpack_require__(33));
    Vue.component('detail-purchase-codes', __webpack_require__(38));

    Vue.component('index-money', __webpack_require__(43));
    Vue.component('detail-money', __webpack_require__(46));
    Vue.component('form-money', __webpack_require__(49));

    Vue.component('detail-codepool-codes', __webpack_require__(54));
    Vue.component('detail-codepool-link', __webpack_require__(57));

    //Vue.component('detail-codepool-actions', require('./fields/CodepoolActions'))

    Vue.component('detail-code-validation', __webpack_require__(60));
    Vue.component('form-code-validation', __webpack_require__(63));

    Vue.component('form-shop-engine-model', __webpack_require__(68));
});
...
Component.options.__file = "resources/js/fields/DetailShippingCostOptions.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7bf899fa", Component.options)
  } else {
    hotAPI.reload("data-v-7bf899fa", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Modals_ShippingCostOptionCreateModal__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Modals_ShippingCostOptionCreateModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Modals_ShippingCostOptionCreateModal__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { ShippingCostOptionCreateModal: __WEBPACK_IMPORTED_MODULE_1__components_Modals_ShippingCostOptionCreateModal___default.a },
    ...
    methods: {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().post('/nova-vendor/shopengine/shipping-costs/' + this.resourceId + '/removeOption', {
                                    values: {
                            ...
                            case 2:
                                ...
                                Nova.success(this.__('The :resource was deleted!', {
                                    resource: 'Versandoption'
                                }));

                                this.field.value = this.field.value.filter(function (option) {
        ...
        saveOption: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee2(values) {
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return Nova.request().post('/nova-vendor/shopengine/shipping-costs/' + this.resourceId + '/addOption', { values: values });
            ...
            function saveOption(_x) {
                return _ref2.apply(this, arguments);
            }

            return saveOption;
        }(),
        formatMoney: function formatMoney(obj) {
            return __WEBPACK_IMPORTED_MODULE_2__helper__["a" /* default */].formatMoney(obj);
        }
    }
});
...
Component.options.__file = "resources/js/components/Modals/ShippingCostOptionCreateModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47134fe3", Component.options)
  } else {
    hotAPI.reload("data-v-47134fe3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        handleSave: function handleSave() {
            ...
            var currency = Nova.config.shopCurrency;
            var data = {
                price: {
                ...
                validation: {
                    sub: {
                        amount: Math.round(this.min * 100),
                        currency: currency
                    }
                }
            };
        ...
        _c(
          ...
          [
            _c("heading", { staticClass: "mb-6", attrs: { level: 2 } }, [
              _vm._v("Option hinzufügen")
            ]),
            _vm._v(" "),
            _c("p", { staticClass: "py-2 text-80 leading-normal" }, [
              _c("label", { attrs: { for: "shipping-cost-option-price" } }, [
                _vm._v("Preis")
              ]),
              _vm._v(" "),
              _c("input", {
            ...
            _vm._v(" "),
            _c("p", { staticClass: "py-2 text-80 leading-normal" }, [
              _c("label", { attrs: { for: "shipping-cost-option-min" } }, [
                _vm._v("Warenkorb Mindestwert")
              ]),
              _vm._v(" "),
              _c("input", {
                directives: [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-47134fe3", module.exports)
  }
}
    ...
    [
      ...
      _vm.optionModalOpen
        ? _c(
            ...
            [
              _vm.optionModalOpen
                ? _c("ShippingCostOptionCreateModal", {
                    attrs: { shop: this.resource.shop },
                    on: { save: _vm.saveOption, close: _vm.closeOptionModal }
                  })
                : _vm._e()
            ],
            1
        ...
        : _vm._e(),
      _vm._v(" "),
      _c("table", { staticClass: "table card w-full" }, [
        _vm._m(0),
        _vm._v(" "),
        _c(
          "tbody",
          _vm._l(_vm.field.value, function(option) {
            return _c("tr", { key: option.id }, [
              _c("td", { staticClass: "text-left" }, [
                _vm._v(_vm._s(_vm.formatMoney(option.price)))
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "left" }, [
                _vm._v(_vm._s(_vm.formatMoney(option.validation.sub)))
              ]),
              _vm._v(" "),
              _c(
                "td",
                [
                  _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.openDeleteModal(option.id)
                        }
                      }
                    },
                    [
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "text-left" }, [_vm._v("Preis")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7bf899fa", module.exports)
  }
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-6dbd34ac"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/DetailShippingCostValidaton.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6dbd34ac", Component.options)
  } else {
    hotAPI.reload("data-v-6dbd34ac", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var update = __webpack_require__(2)("5a813be1", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6dbd34ac\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailShippingCostValidaton.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6dbd34ac\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailShippingCostValidaton.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        period: function period() {
            return this.field.value.filter(function (validation) {
                return validation.type === 'period';
            });
        },
        paymentMethod: function paymentMethod() {
            return this.field.value.filter(function (validation) {
                return validation.type === 'payment_method';
            });
        },
        postbox: function postbox() {
            return this.field.value.filter(function (validation) {
                return validation.type === 'postbox';
            });
        },
        article: function article() {
            return this.field.value.filter(function (validation) {
                return validation.type === 'article';
            });
        }
    }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "relative w-full" }, [
    _vm._m(0),
    _vm._v(" "),
    _c("table", { staticClass: "table bg-white w-full" }, [
      _vm._m(1),
      _vm._v(" "),
      _c("tbody", [
        _vm.period.length > 0
          ? _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("td", [
                  _vm._v("Versandart ist nur innerhalb dieser gültig")
                ]),
                _vm._v(" "),
                _vm._l(_vm.period, function(validation) {
                  return _c("td", [
                    _c("div", [_vm._v(_vm._s(validation.fromWeekDay))]),
                    _vm._v(" "),
                    _c("div", [_vm._v(_vm._s(validation.fromTime))]),
                    _vm._v(" "),
                    _c("div", [_vm._v(_vm._s(validation.toWeekDay))]),
                    _vm._v(" "),
                    _c("div", [_vm._v(_vm._s(validation.toTime))])
                  ])
                })
              ],
              2
          ...
          : _vm._e(),
        _vm._v(" "),
        _vm.postbox.length > 0
          ? _c("tr", [
              _c("td", [_vm._v("Packstation")]),
              _vm._v(" "),
              _c("td", [
                _vm._v(
                  "Die Versandart kann nicht nicht in Kombination mit einer Packstation gewählt werden"
                )
              ]),
              _vm._v(" "),
              _c("td", [_vm._v("Ausgeschlossen")])
            ])
          : _vm._e(),
        _vm._v(" "),
        _vm.paymentMethod.length > 0
          ? _c(
              "tr",
              [
                _c("td", [_vm._v("Zahlarten")]),
                _vm._v(" "),
                _c("td", [
                  _vm._v(
                    "Die Versandart kann nicht nicht in Kombination mit diesen Zahlarten gewählt werden"
                  )
                ]),
                _vm._v(" "),
                _vm._l(_vm.paymentMethod, function(validation) {
                  return _c("td", [
                    _c("div", [_vm._v(_vm._s(validation.invalidPaymentMethod))])
                  ])
                })
              ],
              2
        ...
        _vm.article.length > 0
          ? _c(
              ...
              [
                ...
                _c("td", [
                  _vm._v(
                    "Die Versandart kann nicht nicht in Kombination mit diesen Artikel gewählt werden"
                  )
                ]),
                _vm._v(" "),
                _vm._l(_vm.article, function(validation) {
                  return _c("td", [_c("div", [_vm._v(_vm._s(validation.id))])])
                })
              ],
              2
            )
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "text-left" }, [_vm._v("Typ")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-left" }, [_vm._v("Beschreibung")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-left" }, [_vm._v("Wert")])
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6dbd34ac", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/DetailAddress.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e07a472a", Component.options)
  } else {
    hotAPI.reload("data-v-e07a472a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c(
    ...
    [
      _c("template", { slot: "value" }, [
        _vm._v("\n        " + _vm._s(_vm.field.value.name)),
        _c("br"),
        _vm._v(" "),
        _vm.field.value.addressLine1
          ? _c("span", [_vm._v(_vm._s(_vm.field.value.addressLine1)), _c("br")])
          : _vm._e(),
        _vm._v("\n        " + _vm._s(_vm.field.value.addressLine2)),
        _c("br"),
        _vm._v(
          "\n        " +
            _vm._s(_vm.field.value.postalCode) +
            " " +
            _vm._s(_vm.field.value.addressLevel2)
        ),
        _c("br"),
        _vm._v("\n        " + _vm._s(_vm.field.value.country) + "\n    ")
      ])
    ],
    2
  )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-e07a472a", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-0e8bc0f7"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/DetailPurchaseArticles.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0e8bc0f7", Component.options)
  } else {
    hotAPI.reload("data-v-0e8bc0f7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("1a99d75b", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0e8bc0f7\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailPurchaseArticles.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0e8bc0f7\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailPurchaseArticles.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\ntbody tr:last-child td[data-v-0e8bc0f7] {\n    border-bottom: none;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['field'],
    methods: {
        articleTotalPrice: function articleTotalPrice(article) {
            var totalPrice = _extends({}, article.price);
        ...
        formatMoney: function formatMoney(money) {
            return __WEBPACK_IMPORTED_MODULE_0__helper__["a" /* default */].formatMoney(money);
        }
    }
});
    ...
    [
      _c("template", { slot: "value" }, [
        _c("table", { staticClass: "table" }, [
          _c("thead", [
            _c("tr", [
              _c("th", { staticClass: "text-left" }, [_vm._v("Artikel")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-left" }, [_vm._v("SKU")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-left" }, [_vm._v("Anzahl")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-right" }, [_vm._v("Einzelpreis")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-right" }, [_vm._v("Preis")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-right" }, [_vm._v("Steuern")])
            ])
          ]),
          _vm._v(" "),
          _c(
            "tbody",
            _vm._l(_vm.field.value, function(article) {
              return _c("tr", [
                _c("td", [_vm._v(_vm._s(article.name))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(article.sku))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(article.quantity))]),
                _vm._v(" "),
                _c("td", { staticClass: "text-right" }, [
                  _vm._v(_vm._s(_vm.formatMoney(article.price)))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-right" }, [
                  _vm._v(_vm._s(_vm.articleTotalPrice(article)))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "text-right" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0e8bc0f7", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-3caa0ef2"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/DetailPurchaseOriginStatus.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3caa0ef2", Component.options)
  } else {
    hotAPI.reload("data-v-3caa0ef2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("3aaa28b2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3caa0ef2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailPurchaseOriginStatus.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3caa0ef2\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailPurchaseOriginStatus.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['field', 'resourceName', 'resourceId', 'resource'],
    data: function data() {
        return {
            loading: false,
    ...
    methods: {
        send: function send() {
            ...
            if (confirm('Wirklich?')) {
                ...
                Nova.request().post('/nova-vendor/shopengine/purchases/' + this.resourceId + '/origin-status').then(function (response) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.canUpdateOriginStatus
    ? _c(
        "panel-item",
        { attrs: { field: _vm.field } },
        [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3caa0ef2", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-c0215946"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/DetailCodes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c0215946", Component.options)
  } else {
    hotAPI.reload("data-v-c0215946", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("129c4288", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c0215946\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailCodes.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c0215946\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailCodes.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\ntbody tr:last-child td[data-v-c0215946] {\n    border-bottom: none;\n}\n", ""]);
        ...
        _c("table", { staticClass: "table" }, [
          _c("thead", [
            _c("tr", [
              ...
              _vm._v(" "),
              _c("th", { staticClass: "text-left" }, [_vm._v("Codepool")]),
              _vm._v(" "),
              _c("th", { staticClass: "text-left" }, [_vm._v("Rabatt")])
            ])
          ]),
          _vm._v(" "),
          _c(
            "tbody",
            _vm._l(_vm.field.value, function(code) {
              return _c("tr", [
                  ...
                  [
                    _c(
                      "router-link",
                      {
                        staticClass: "text-80",
                        attrs: {
                          to: "/shopengine-codepools/" + code.codepoolId
                        }
                      },
                      [_vm._v(_vm._s(code.codepoolName))]
                    )
                  ],
                  1
                ),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(code.usedValue))])
              ])
            }),
            0
          )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c0215946", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/IndexMoney.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f66dd094", Component.options)
  } else {
    hotAPI.reload("data-v-f66dd094", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        value: function value() {
            return __WEBPACK_IMPORTED_MODULE_0__helper__["a" /* default */].formatMoney(this.field.value, this.locale);
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f66dd094", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/DetailMoney.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7bee86f7", Component.options)
  } else {
    hotAPI.reload("data-v-7bee86f7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['resource', 'resourceName', 'resourceId', 'field'],
    computed: {
        reformattedField: function reformattedField() {
            var newField = _extends({}, this.field);
            newField.value = __WEBPACK_IMPORTED_MODULE_0__helper__["a" /* default */].formatMoney(this.field.value);
            return newField;
        }
    }
});
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("panel-item", { attrs: { field: _vm.reformattedField } })
}
var staticRenderFns = []
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7bee86f7", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7f145fe4"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/FormMoney.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7f145fe4", Component.options)
  } else {
    hotAPI.reload("data-v-7f145fe4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("774023b6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7f145fe4\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormMoney.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7f145fe4\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormMoney.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\ninput[data-v-7f145fe4] {\n    padding-right: 45px\n}\n.floaty[data-v-7f145fe4] {\n    position: absolute;\n    top: 0;\n    right: 8px;\n    width: 30px;\n    text-align: right;\n    padding-right: .75rem;\n    height: 2.25rem;\n    line-height: normal;\n}\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        fill: function fill(formData) {
            var json = JSON.stringify({ amount: Math.round(this.amount * 100), currency: this.field.currency });
            formData.append(this.field.attribute, json);
        },
        handleChange: function handleChange(amount) {
            this.amount = amount;
        }
    }
});
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7f145fe4", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/CodepoolCodes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-575a0725", Component.options)
  } else {
    hotAPI.reload("data-v-575a0725", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setDataFromRouter: function setDataFromRouter(query) {
            if (!query) {
                return;
            }
        ...
        orderChange: function orderChange(query) {
            console.log(query);
        },
        list: function list() {
            var _this = this;
            ...
            var params = _extends({}, this.query, { 'codepoolId-eq': this.resourceId });

            Nova.request().get('/nova-vendor/shopengine/codes', { params: params }).then(function (response) {
                if (response.headers['content-type'] !== 'application/json') {
                    console.error(response);
                    return;
                }

                _this.label = response.data.label;
                _this.resources = response.data.resources;
                _this.count = response.data.count;
                var maxPages = Math.ceil(_this.count / _this.query.pageSize) - 1;

                _this.hasPreviousPage = _this.query.page >= 1;
                _this.hasNextPage = _this.query.page < maxPages;
                _this.loading = false;
                _this.perPageOptions = response.data.per_page_options;
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "card",
      staticStyle: { margin: "-0.75rem -1.5rem" },
    ...
    [
      !_vm.isArchived
        ? _c(
            ...
            {
              staticClass: "btn btn-default btn-primary",
              staticStyle: { position: "absolute", right: "0", top: "-48px" },
              attrs: {
                to:
                  "/shopengine/" +
                  _vm.inlineResourceName +
                  "/new?codepoolId=" +
                  _vm.resourceId
              }
            },
            [
              _vm._v(
                "\n        " +
                  _vm._s(_vm.__("Create :resource", { resource: _vm.label })) +
                  "\n    "
              )
            ]
          )
      ...
      _c(
        ...
        [
          _c("resource-table", {
            attrs: {
              "resource-name": _vm.inlineResourceName,
              resources: _vm.resources,
              fields: _vm.fields
            },
            on: { orderChange: _vm.orderChange }
          })
        ],
        1
      ),
          ...
          [
            _c(
              "router-link",
              {
                ...
                class: { "opacity-50": !_vm.hasPreviousPage },
                attrs: {
                  to:
                    "/resources/" +
                    _vm.resourceName +
            ...
            _c("span", { staticClass: "text-sm text-80 px-4" }, [
              _vm._v(
                _vm._s(_vm.query.page * _vm.query.pageSize + 1) +
                  "-" +
                  _vm._s(
                    Math.min(
                      (_vm.query.page + 1) * _vm.query.pageSize,
                      _vm.count
                    )
                  ) +
                  " of " +
            ...
            _c(
              ...
              {
                staticClass: "btn btn-link py-3 px-4 text-80",
                class: { "opacity-50": !_vm.hasNextPage },
                attrs: {
                  to:
                    "/resources/" +
                    _vm.resourceName +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-575a0725", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/DetailCodepoolLink.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-453d93bc", Component.options)
  } else {
    hotAPI.reload("data-v-453d93bc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
        ...
        [
          _c(
            "router-link",
            {
              ...
              attrs: {
                to: "/resources/codepools/" + _vm.field.value,
                title: "View"
              }
            },
            [
              _vm._v(
                "\n            " +
                  _vm._s(_vm.resource.seModel.codepoolName) +
                  "\n        "
              )
            ]
          )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-453d93bc", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/DetailCodeValidation.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-597085c2", Component.options)
  } else {
    hotAPI.reload("data-v-597085c2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    [
      _c("template", { slot: "value" }, [
        _c(
          "table",
          { staticClass: "table" },
          _vm._l(_vm.field.value, function(validation) {
            return _c("tr", [
              _c("td", [_vm._v(_vm._s(_vm.label(validation.type)))]),
              _vm._v(" "),
              _c("td", [_vm._v(_vm._s(_vm.value(validation.value)))])
            ])
          }),
          0
        )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-597085c2", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-ad9ac25c"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/js/fields/FormCodeValidation.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ad9ac25c", Component.options)
  } else {
    hotAPI.reload("data-v-ad9ac25c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("34adbd10", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ad9ac25c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormCodeValidation.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-ad9ac25c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./FormCodeValidation.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setInitialValue: function setInitialValue() {
            ...
            try {
                for (var _iterator = this.field.value[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    var v = _step.value;
        ...
        handleExpiresChange: function handleExpiresChange(value) {
            this.expires = value;
        }
    }
});
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
            ...
            [
              ...
              _c(
                "a",
                {
                  ...
                  class: {
                    "text-50": !_vm.start,
                    "text-black hover:text-danger": !!_vm.start
                  },
                  attrs: {
                    href: "#",
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.$refs.startDateTimePicker.clear()
                    }
                  }
                },
                [
          ...
          _c(
            ...
            [
              _c("date-time-picker", {
                ...
                on: { change: _vm.handleExpiresChange }
              }),
              _vm._v(" "),
              _c(
                "a",
                {
                  ...
                  class: {
                    "text-50": !_vm.expires,
                    "text-black hover:text-danger": !!_vm.expires
                  },
                  attrs: {
                    href: "#",
                    title: _vm.__("Clear value"),
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.$refs.expiresDateTimePicker.clear()
                    }
                  }
                },
                [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "pb-4" }, [
          _c("label", [_vm._v("Verbleibende Benutzungen")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
            ...
            domProps: { value: _vm.usageCount },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.usageCount = $event.target.value
              }
            }
          })
        ]),
        ...
        _c("div", { staticClass: "pb-4" }, [
          ...
          _c("input", {
            ...
            staticClass:
              "w-full form-control form-input form-input-bordered mt-2",
            class: _vm.errorClasses,
            attrs: { type: "email", placeholder: "max@musterman.de" },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ad9ac25c", module.exports)
  }
}
...
Component.options.__file = "resources/js/fields/FormShopEngineModel.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-217500d5", Component.options)
  } else {
    hotAPI.reload("data-v-217500d5", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        filteredOptions: function filteredOptions() {
            ...
            return this.options.filter(function (option) {
                return option.label.toLowerCase().indexOf(_this.search.toLowerCase()) > -1;
            });
        },
    ...
    mounted: function mounted() {
        ...
        Nova.request().get('/nova-api/' + this.field.uriKey, { params: {
            ...
            _this2.options = response.data.resources.map(function (resource) {
                var value = _this2.field.valueFieldName ? resource.fields.find(function (field) {
                    return field.attribute === _this2.field.valueFieldName;
                }).value : resource.id.value;

                return {
                    label: resource.fields.find(function (field) {
                        return field.attribute === _this2.field.labelFieldName;
                    }).value,
                    value: value
                };
            });

            _this2.selectedOption = _this2.options.find(function (option) {
        ...
        [
          _c(
            "search-input",
            {
              ...
              on: { input: _vm.performSearch, selected: _vm.selectOption },
              scopedSlots: _vm._u([
                {
                  key: "option",
                  fn: function(ref) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-217500d5", module.exports)
  }
}
